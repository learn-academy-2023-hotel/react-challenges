...
1. object in an array
    const ()
        {food items: xxx(string)
        price:xxx(string/number) } 
    array = [
        {}
        {}
        {}   
...
2. create a button 
    build a compoment called Menu.js
    and use props
<button onClick => </button>

3. display 
two boxes in one compoment 
one box has the logic 
another box mirrors the logic 
